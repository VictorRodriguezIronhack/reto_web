export const technologies = [
    { name: 'React', difficulty: 4, concepts: ['State', 'props', 'UI Library'] },
    { name: 'Node.js', difficulty: 10, concepts: ['Runtime environment', 'Chrome V8 Engine'] },
    { name: 'Express.js', difficulty: 6, concepts: ['Middlewares', 'Controllers', 'Routes'] },
    { name: 'MongoDB', difficulty: 2, concepts: ['Documents', '_id', 'Non-relational'] },
    { name: 'JS', difficulty: 1, concepts: ['scope', 'this', 'function', 'variable'] }
  ];
