...
class PhoneForm extends Component {
    ...
    render() {
        ...
        return (
            <Container style={{ height: '950px', fontFamily: 'Cormorant Unicase' }}>
                <Form onSubmit={(e) => this.handleSubmit(e)}>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="Number" name="price" value={this.state.phone.price} onChange={e => this.handleInputChange(e)} />
                    </Form.Group>
                    <Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="Number" name="ram" value={this.state.phone.ram} onChange={e => this.handleInputChange(e)} />
                    </Form.Group>
                    <Form.Group>
                        <Form.Label>Add image (File):{this.state.isUploading && <Spinner />}</Form.Label>
                        <Form.Control type="file" name="imageFileName" onChange={e => this.handleFileUpload(e)} />
                    </Form.Group>
                    <Button variant="primary" className="btn btn-dark" type="submit">Done</Button>
                </Form>
            </Container>
        )
    }
